...
--> 에러 발생: col_3은 unigue 제약 조건인데, 기존에 입력된 값과 같은 'test'를 insert하려고 했기 때문에
...
create table ex02 (
    col_1   number(4)
            constraint ex02_col1_px primary key,
    col_2   varchar2(10)
...
create table ex03 (
    ...
    col4 varchar2(1),
    -- 제약 조건 정의:
    constraint ex03_col1_pk primary key (col1),         -- PRIMARY
...
-- 테이블를 삽입(insert)를 할 때 다른 테이블의 PK에 없는 값은 저장되지 않도록 하기 위해서 사용.
