...
-- Ex. ALLEN과 같은 직무의 직원들의 사번, 이름, 부서번호, 직책, 급여를 검색
...
-- 연봉 내림차순으로 출력.
select empno, ename, sal, comm, sal * 12 + nvl2(comm, comm, 0) as "ANNUAL_SAL"
from emp
