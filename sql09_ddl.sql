 ...
 * 4. TCL(Tranaction Control Language): 트랜잭션 관리(제어) 언어.
 ...
 */
 ...
 -- create-select 문장: 다른 테이블에서 select한 내용 그대로 새로운 테이블을 생성.
