...
-- alter user ht identified by hr;
...
-- (3) 제약 조건 이름 변경: ex01 테이블의 SYS_C007001 제약 조건 이름을 ex01_col1_pk로 변경.
alter table ex01 rename constraint SYS_C007001 to ex01_col1_px;
